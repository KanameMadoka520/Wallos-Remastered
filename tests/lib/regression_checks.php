...
function wallos_regression_run_static_suite(array $config, array $suiteDefinition)
{
    ...
    $remasteredVersionValid = strpos($versionPhp, '$version = "v5.4.5";') !== false
        && strpos($versionPhp, '$remasteredVersion = "v5.4.5-remastered.6";') !== false
    ...
    $maintenanceValid = wallos_regression_text_has_all($systemMaintenancePhp, array(
        ...
        'wallos_count_recent_failed_maintenance_actions',
        'wallos_get_maintenance_action_log_summary',
        ...
        'system_overview_maintenance_action_failures',
        ...
        'maintenance_recommendation_failed_actions_title',
        'open_failed_maintenance_actions',
        'maintenance_recommendation_slow_actions_title',
        ...
        'adminMaintenanceActionSummary',
        'export_maintenance_action_logs',
        'copy_maintenance_action_logs',
        ...
        'renderAdminMaintenanceActionSummary',
        ...
        'copyAdminMaintenanceActionLogs',
        'formatAdminMaintenanceActionLogsForCopy',
        'maintenance_action_logs_copied',
        'open_failed_maintenance_actions',
        'open_slow_maintenance_actions',
        ...
        'subscription_image_largest_orphan_samples',
        'subscription_image_reclaimable_size_estimate',
    ...
    $adminObservabilityValid = wallos_regression_text_has_all($runtimeObservability, array(
        ...
        'data-observability-generated-at',
        'data-observability-feed',
        'top_slow_endpoints',
        'open_slow_endpoint_logs',
        'data-slow-endpoint-method',
        'data-total-duration-label',
        'data-failure-rate-label',
        'openAdminSlowEndpointLogs(this)',
        'slow_requests_24h',
        ...
        'observability-generated-at',
        'createRuntimeSlowEndpointCard',
        'totalDurationLabel',
        'failureRateLabel',
        'openAdminSlowEndpointLogs',
        'slowEndpointLogsLabel',
        'slowEndpointMethod',
