...
$db->exec('UPDATE settings SET subscription_display_columns = 1 WHERE subscription_display_columns IS NULL');
...
$db->exec("UPDATE settings SET subscription_image_layout_form = 'focus' WHERE subscription_image_layout_form IS NULL OR TRIM(subscription_image_layout_form) = ''");
$db->exec("UPDATE settings SET subscription_image_layout_detail = 'focus' WHERE subscription_image_layout_detail IS NULL OR TRIM(subscription_image_layout_detail) = ''");
