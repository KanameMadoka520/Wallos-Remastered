...
$i18n = [
    ...
    "used_by" => "已被谁使用",
    "recycle_bin" => "回收站",
    "recycle_bin_empty" => "回收站当前没有用户。",
    "recycle_bin_reason_label" => "移入原因",
    "recycle_bin_trashed_at" => "移入时间",
    "recycle_bin_scheduled_delete_at" => "计划删除时间",
    "recycle_bin_reason_required" => "请输入移入回收站的原因。",
    "user_moved_to_recycle_bin" => "用户已移入回收站。",
    "restore_user" => "恢复用户",
    "permanently_delete_user" => "彻底删除用户",
    "user_restored_from_recycle_bin" => "用户已从回收站恢复。",
    "user_permanently_deleted" => "用户已被彻底删除。",
    "account_in_recycle_bin" => "该账号已被移入回收站，当前无法登录。如需恢复，请联系管理员。",
