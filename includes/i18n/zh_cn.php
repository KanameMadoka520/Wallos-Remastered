...
$i18n = [
    ...
    "subscription_image_trusted_notice" => "受信用户可以为每个订阅上传 1 张图片到服务器。为了保护硬盘和带宽，压缩会强制保持开启。",
    ...
    "subscription_image_trusted_notice_dynamic" => "受信用户可以为每个订阅上传最多 %d 张图片到服务器。为了保护硬盘和带宽，压缩会强制保持开启。",
