...
$i18n = [
    ...
    "subscription_image_trusted_notice" => "受信使用者可以為每個訂閱上傳 1 張圖片到伺服器。為了保護硬碟與頻寬，壓縮會強制保持開啟。",
    ...
    "subscription_image_trusted_notice_dynamic" => "受信使用者可以為每個訂閱上傳最多 %d 張圖片到伺服器。為了保護硬碟與頻寬，壓縮會強制保持開啟。",
