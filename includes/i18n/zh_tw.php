...
$i18n = [
    ...
    "used_by" => "已被誰使用",
    "recycle_bin" => "回收站",
    "recycle_bin_empty" => "回收站目前沒有使用者。",
    "recycle_bin_reason_label" => "移入原因",
    "recycle_bin_trashed_at" => "移入時間",
    "recycle_bin_scheduled_delete_at" => "預計刪除時間",
    "recycle_bin_reason_required" => "請輸入移入回收站的原因。",
    "user_moved_to_recycle_bin" => "使用者已移入回收站。",
    "restore_user" => "還原使用者",
    "permanently_delete_user" => "徹底刪除使用者",
    "user_restored_from_recycle_bin" => "使用者已從回收站還原。",
    "user_permanently_deleted" => "使用者已被徹底刪除。",
    "account_in_recycle_bin" => "該帳號已被移入回收站，目前無法登入。如需恢復，請聯絡管理員。",
    "recycle_bin_reason_prefix" => "原因：",
