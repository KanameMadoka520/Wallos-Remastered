...
$i18n = array_replace($i18n, [
    ...
    "upcoming_cancellations" => "Предстоящі скасування",
    "upcoming_payments_to_show" => "Показувані майбутні платежі",
    "notes_bold" => "Жирний",
    "notes_italic" => "Курсив",
    "notes_list" => "Список",
    "notes_link" => "Посилання",
    "potential_monthly_savings" => "Потенційна щомісячна економія",
    "potential_yearly_savings" => "Потенційна щорічна економія",
    "allow_standard_users_local_webhooks" => "Дозволити звичайним користувачам використовувати список дозволених адрес для вебхуків",
    "allow_standard_users_local_webhooks_info" => "Ризик безпеки: увімкнення цього дозволить будь-якому звичайному (не адміністратору) користувачеві надсилати сповіщення на адреси зі списку дозволених адрес для вебхуків вище, включно з внутрішніми службами у вашій мережі. Вмикайте це лише якщо довіряєте всім користувачам цього екземпляра Wallos.",
]);
