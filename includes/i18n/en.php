...
$i18n = [
    ...
    "user_group_management_info" => "Only administrators can change user groups. Free users can use external image URLs only, while trusted users can also upload server-hosted images for subscription details.",
    "subscription_images" => "Subscription Images",
    "subscription_image_upload" => "Upload Server Image",
    ...
    "subscription_image_limits_notice" => "Server-hosted uploads are limited to 10 MB per image and only JPEG, PNG, and WebP files are accepted. External image URLs must use http or https and are limited to 10 entries.",
    "subscription_image_admin_notice" => "As administrator, you can upload server-hosted images and optionally disable compression for the current upload. Uploaded files are still re-encoded for safety.",
    "subscription_image_trusted_notice" => "Trusted users can upload one server-hosted image per subscription. Compression stays enabled to protect storage and bandwidth.",
    "subscription_image_free_notice" => "Free users cannot upload server-hosted images. You can still add up to 10 external image URLs. Contact tcy if you need trusted upload access.",
    "subscription_image_compress_toggle" => "Compress uploaded server image",
    "subscription_image_no_upload_permission" => "Your current account group cannot upload server-hosted images for subscriptions.",
    ...
    "subscription_image_upload_limit_dynamic" => "You can upload at most %d server-hosted subscription images to this subscription.",
    "subscription_deleted" => "Subscription deleted.",
    "subscription_image_limits_notice_dynamic" => "Server-hosted uploads are limited to %d MB per image. Allowed extensions: %s. External image URLs must use http or https and are limited to %d entries.",
    "subscription_image_trusted_notice_dynamic" => "Trusted users can upload up to %d server-hosted images per subscription. Compression stays enabled to protect storage and bandwidth.",
    "subscription_image_free_notice_dynamic" => "Free users cannot upload server-hosted images. You can still add up to %d external image URLs. Contact tcy if you need trusted upload access.",
    ...
    "subscription_image_storage_info" => "Uploaded subscription images are stored in the persistent Docker-mounted image upload directory and indexed separately in the database.",
    ...
    "subscription_image_no_selection" => "No server-hosted images selected.",
    ...
    "homepage_upload_policy_admin" => "Your account is the administrator account. You can upload server-hosted images, and you may decide case by case whether the current upload should be compressed.",
    "homepage_upload_policy_trusted" => "Your account is trusted. You can upload one server-hosted image per subscription, and uploaded images are always compressed automatically for storage safety.",
    "homepage_upload_policy_free" => "Your account is Free. You can still attach up to 10 external image URLs per subscription, but server-hosted image uploads are disabled until tcy manually upgrades your account.",
    // Settings page
