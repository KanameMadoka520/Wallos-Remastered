...
$i18n = [
    ...
    "recycle_bin_empty" => "There are no users in the recycle bin.",
    "recycle_bin_reason_label" => "Reason",
    "recycle_bin_trashed_at" => "Moved To Recycle Bin",
    "recycle_bin_scheduled_delete_at" => "Scheduled Deletion",
    "recycle_bin_reason_required" => "A recycle-bin reason is required.",
    "user_moved_to_recycle_bin" => "User moved to the recycle bin.",
    "restore_user" => "Restore User",
    "permanently_delete_user" => "Permanently Delete User",
    "user_restored_from_recycle_bin" => "User restored from the recycle bin.",
    "user_permanently_deleted" => "User permanently deleted.",
    "account_in_recycle_bin" => "This account has been moved to the recycle bin and cannot log in right now. Please contact the administrator if this should be reversed.",
    "recycle_bin_reason_prefix" => "Reason:",
