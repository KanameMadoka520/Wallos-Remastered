...
$i18n = [
    ...
    "subscription_image_trusted_notice" => "Trusted users can upload one image to the server per subscription. Compression stays enabled to protect storage and bandwidth.",
    ...
    "subscription_image_trusted_notice_dynamic" => "Trusted users can upload up to %d images to the server per subscription. Compression stays enabled to protect storage and bandwidth.",
