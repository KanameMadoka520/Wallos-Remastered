...
require_once __DIR__ . '/includes/theme_color.php';

$theme = sanitize_theme_mode($_COOKIE['theme'] ?? null);
if ($theme === 'automatic') {
    $theme = sanitize_resolved_theme($_COOKIE['inUseTheme'] ?? null);
}
$themeColor = wallos_resolve_theme_color_value(
    $theme, sanitize_color_theme($_COOKIE['colorTheme'] ?? null, 'purple')
);
$backgroundColor = $theme === 'light' ? '#FFFFFF' : '#222222';

$manifest = [
    'short_name' => 'Wallos',
    'name' => 'Wallos Remastered - Subscription Tracker',
    'icons' => [
        [
