        ...
        $notificationsWebhook['payload'] = '
{
    ...
    <section class="account-section" id="settings-theme" data-page-section>
        ...
        <div class="account-settings-theme">
            <?php $pageTransitionLabels = wallos_get_page_transition_setting_labels($lang); ?>
            <div>
            ...
            <div>
                <h3><?= htmlspecialchars($pageTransitionLabels['section_title'], ENT_QUOTES, 'UTF-8') ?></h3>
                <div class="form-group-inline">
                    <input type="checkbox" id="pagetransitionenabled" name="pagetransitionenabled"
