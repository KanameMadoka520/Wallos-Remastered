...
function applyPaymentRulePreviewForDueDate(dueDate) {
  window.WallosSubscriptionPayments?.applyCurrentPriceRulePreview?.(dueDate);
}
...
function resetSubscriptionPaymentForm() {
  window.WallosSubscriptionPayments?.resetSubscriptionPaymentForm?.();
}

function closeSubscriptionPaymentModal(options = {}) {
  window.WallosSubscriptionPayments?.closeSubscriptionPaymentModal?.(options);
}

function fillSubscriptionPaymentForm(subscription) {
  window.WallosSubscriptionPayments?.fillSubscriptionPaymentForm?.(subscription);
}

function fillSubscriptionPaymentFormFromRecord(subscriptionId, subscriptionName, record) {
  window.WallosSubscriptionPayments?.fillSubscriptionPaymentFormFromRecord?.(subscriptionId, subscriptionName, record);
}

function openSubscriptionPaymentModal(event, id) {
  window.WallosSubscriptionPayments?.openSubscriptionPaymentModal?.(event, id);
}

function closeSubscriptionPaymentHistoryModal() {
  window.WallosSubscriptionPayments?.closeSubscriptionPaymentHistoryModal?.();
}
...
function exportSubscriptionPaymentHistoryCurrentView(format) {
  window.WallosSubscriptionPayments?.exportSubscriptionPaymentHistoryCurrentView?.(format);
}

function setSubscriptionPaymentHistoryTab(tab) {
  window.WallosSubscriptionPayments?.setSubscriptionPaymentHistoryTab?.(tab);
}

function renderSubscriptionPaymentHistoryModal() {
  window.WallosSubscriptionPayments?.renderSubscriptionPaymentHistoryModal?.();
}
...
function openEditSubscriptionPaymentModal(event, subscriptionId, recordId) {
  window.WallosSubscriptionPayments?.openEditSubscriptionPaymentModal?.(event, subscriptionId, recordId);
}

function deleteSubscriptionPaymentRecord(event, subscriptionId, recordId) {
  window.WallosSubscriptionPayments?.deleteSubscriptionPaymentRecord?.(event, subscriptionId, recordId);
}
