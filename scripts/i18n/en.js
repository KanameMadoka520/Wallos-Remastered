let i18n = {
  ...
  notes: "Notes",
  export: "Export",
  recycle_bin_reason_prompt: "Enter the reason for moving this user to the recycle bin:",
  recycle_bin_reason_required: "A recycle-bin reason is required.",
  confirm_move_user_to_recycle_bin: "Move this user to the recycle bin now?",
